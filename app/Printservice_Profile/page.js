        ...
        <Box>
          ...
          <Box sx={{ display: 'flex', gap: 2, overflowX: 'auto' }}>
            <Card sx={{ minWidth: 300 }}>
              <CardContent>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaW00qe6KCC22-NsR3Lj5GgAzID3T33wm1UA&s" style={{ width: '100%', borderRadius: 4 }} />
                <Typography variant="body1" sx={{ mt: 1 }}>Australian Mastermind Logo</Typography>
              </CardContent>
            </Card>
            <Card sx={{ minWidth: 300 }}>
              <CardContent>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6wyzOb2joE5jVSJmhsI2Hn6vA7PpO8-eIrw&s" style={{ width: '100%', borderRadius: 4 }} />
